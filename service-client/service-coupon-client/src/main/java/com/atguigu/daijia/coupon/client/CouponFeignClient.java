...
public interface CouponFeignClient {
    ...
    Result<Boolean> receive(@PathVariable Long customerId,
     ...
     * @param customerId
     * @param orderAmount
     * @return List<AvailableCouponVo>
     */
    @GetMapping("/coupon/info/findAvailableCoupon/{customerId}/{orderAmount}")
    Result<List<AvailableCouponVo>> findAvailableCoupon(@PathVariable Long customerId,
